...
\newpage
\begin{abstract}
Network-model misspecification poses a challenge for parameter estimation. The problem is amplified by missing data, as there is imputation error feeding back into distorted parameter estimates and vis versa. The problem of model misspecification has been a focus of recent work in the literature for Bayesian statistical methods, and new misspecification-robust procedures have been developed, in particular the method of cutting feedback between model modules. % removed Plummer because author guidelines: they dont want references in the abstract
